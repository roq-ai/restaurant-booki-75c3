  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Revolutionizing Table Reservations and Menu Management for Restaurants and their Customers"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Revolutionizing Table Reservations and Menu Management for Restaurants and their Customers`}
            </Text>
            <Box
